...
static const NSInteger rowSpacing=20;
#import "MVPView.h"
...
-(void)initView{
    ...
    self.nameL=[[UITextField alloc] initWithFrame:CGRectMake(20, CGRectGetMaxY(self.btnPrint.frame)+rowSpacing, MCScreenWidth-40, 30)];
    [self addSubview:self.nameL];
    self.nameL.backgroundColor=[UIColor grayColor];
    
    
    self.ageL=[[UITextField alloc] initWithFrame:CGRectMake(20, CGRectGetMaxY(self.nameL.frame)+rowSpacing, MCScreenWidth-40, 30)];
    [self addSubview:self.ageL];
    self.ageL.backgroundColor=[UIColor grayColor];
    
    self.sexL=[[UITextField alloc] initWithFrame:CGRectMake(20, CGRectGetMaxY(self.ageL.frame)+rowSpacing, MCScreenWidth-40, 30)];
    [self addSubview:self.sexL];
    self.sexL.backgroundColor=[UIColor grayColor];
    
    
    self.btnGet=[UIButton new];
    self.btnGet.frame=CGRectMake(20, CGRectGetMaxY(self.sexL.frame)+rowSpacing, MCScreenWidth-40, 30);
    ...
    self.contentL=[[UILabel alloc] initWithFrame:CGRectMake(20, CGRectGetMaxY(self.btnGet.frame)+rowSpacing, MCScreenWidth-40, 30)];
